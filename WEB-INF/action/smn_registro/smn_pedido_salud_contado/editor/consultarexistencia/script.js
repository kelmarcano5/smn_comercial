...
var cant_pedid = document.form2.pde_cantidad_pedido.value;
...
if (parseInt(cant_pedid) < parseInt(cant_exist)) {
	document.form2.pde_cantidad_pedido.disabled=false;
	document.form2.grabar2.disabled=false;
	pasar_cantidad();
	

}else{
	//document.form2.pde_cantidad_pedido.disabled=true;
	document.form2.grabar2.disabled=true;
	document.form2.pde_cantidad_pedido.value="";
