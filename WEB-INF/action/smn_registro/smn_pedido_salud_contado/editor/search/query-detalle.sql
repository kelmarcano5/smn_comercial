select
	...
	CASE
		WHEN smn_comercial.smn_pedido_detalle.pde_naturaleza = 'IT' then  smn_base.smn_item.itm_descripcion_estructurada
	...
	smn_comercial.smn_pedido_detalle.pde_monto_moneda_alterna as montoma,
	smn_comercial.smn_pedido_detalle.pde_precio_moneda_alterna as precioma
...
from
	...
	left join smn_comercial.smn_pedido_cabecera on 
...
where
	smn_comercial.smn_pedido_detalle.smn_pedido_cabecera_id=${fld:id2} ORDER BY smn_comercial.smn_pedido_detalle.smn_pedido_detalle_id desc
