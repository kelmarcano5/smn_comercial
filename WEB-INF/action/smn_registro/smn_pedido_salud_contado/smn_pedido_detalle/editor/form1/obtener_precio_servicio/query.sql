...
where smn_base.smn_baremos_detalle.bad_precio_moneda_local is not null and smn_base.smn_baremos_detalle.smn_servicios_rf=${fld:id} and smn_base.smn_baremos_detalle.bad_estatus = 'A'
