select ${fld:smn_ingresos_id} as smn_ingresos_id,
	cliente.smn_v_auxiliar_id as cliente1,
	...
	case when smn_comercial.smn_pedido_cabecera.pca_monto_pedido_ml is null then 0 else smn_comercial.smn_pedido_cabecera.pca_monto_pedido_ml end as monto_ml,
	case when smn_comercial.smn_pedido_cabecera.pca_monto_neto_ml is null then 0 else smn_comercial.smn_pedido_cabecera.pca_monto_neto_ml end as saldo_ml,
	case when smn_comercial.smn_pedido_cabecera.pca_monto_pedido_ma is null then 0 else smn_comercial.smn_pedido_cabecera.pca_monto_pedido_ma end as monto_ma,
	case when smn_comercial.smn_pedido_cabecera.pca_monto_neto_ma is null then 0 else smn_comercial.smn_pedido_cabecera.pca_monto_neto_ma end as saldo_ma,
	...
	case when smn_comercial.smn_pedido_cabecera.pca_monto_impuesto_ml is null then 0 else smn_comercial.smn_pedido_cabecera.pca_monto_impuesto_ml end as impuesto_ml,
	case when smn_comercial.smn_pedido_cabecera.pca_monto_impuesto_ma is null then 0 else smn_comercial.smn_pedido_cabecera.pca_monto_impuesto_ma end as impuesto_ma
from 
