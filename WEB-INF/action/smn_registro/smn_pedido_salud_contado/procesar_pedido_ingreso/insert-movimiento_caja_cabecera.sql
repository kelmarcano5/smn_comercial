...
(
	...
	(select smn_salud.smn_ingresos.igs_num_ingreso from smn_salud.smn_ingresos where smn_salud.smn_ingresos.smn_ingresos_id=${fld:smn_ingresos_id}),--${fld:numero_referencia},--(select smn_base.smn_documentos_generales.smn_documentos_generales_id from smn_comercial.smn_pedido_cabecera inner join smn_comercial.smn_documento on smn_comercial.smn_documento.smn_documento_id = smn_comercial.smn_pedido_cabecera.smn_documento_id inner join smn_base.smn_documentos_generales on smn_base.smn_documentos_generales.smn_documentos_generales_id = smn_comercial.smn_documento.smn_documentos_generales_rf where smn_comercial.smn_pedido_cabecera.smn_pedido_cabecera_id=${fld:smn_pedido_cabecera_id}),
	...
	${fld:impuesto_ml},
	${fld:impuesto_ma}
) RETURNING smn_mov_caja_cabecera_id, ${fld:smn_ingresos_id} as smn_ingresos_id;
