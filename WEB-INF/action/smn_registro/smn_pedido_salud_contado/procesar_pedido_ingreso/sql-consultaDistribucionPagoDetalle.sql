select 
	...
	case when smn_comercial.smn_pago_punto_venta.smn_codigo_impuesto_rf is null then 0 else smn_comercial.smn_pago_punto_venta.smn_codigo_impuesto_rf end as smn_codigo_impuesto_rf,
	case when smn_comercial.smn_pago_punto_venta.ppv_porcentaje is null then 0 else smn_comercial.smn_pago_punto_venta.ppv_porcentaje end as ppv_porcentaje,
	case when smn_comercial.smn_pago_punto_venta.ppv_monto_impuesto_ml is null then 0 else smn_comercial.smn_pago_punto_venta.ppv_monto_impuesto_ml end as ppv_monto_impuesto_ml,
	case when smn_comercial.smn_pago_punto_venta.ppv_monto_impuesto_ma is null then 0 else smn_comercial.smn_pago_punto_venta.ppv_monto_impuesto_ma end as ppv_monto_impuesto_ma
from 
