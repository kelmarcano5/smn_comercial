...
FROM
    ...
    left join smn_salud.smn_prestacion_servicio_medico_cabecera on smn_salud.smn_prestacion_servicio_medico_cabecera.smn_ingresos_id = smn_salud.smn_ingresos.smn_ingresos_id
...
WHERE
    smn_salud.smn_ingresos.smn_ingresos_id = ${fld:smn_ingresos_id} and smn_salud.smn_ingreso_movimiento.smn_unidades_servicios_rf=${fld:smn_unidades_servicios_rf} and 
    smn_base.smn_grupo_prestador_servicio_frecuencia.smn_grupos_prestadores_id=${fld:smn_grupo_prestador_rf}  and smn_salud.smn_ingreso_movimiento.smn_prestador_servicio_rf=0