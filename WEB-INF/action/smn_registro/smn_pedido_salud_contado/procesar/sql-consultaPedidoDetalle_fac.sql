select
	...
	CAST(smn_comercial.smn_pedido_detalle.pde_precio as INTEGER) as fde_precio_ml,
	CAST(smn_comercial.smn_pedido_detalle.pde_monto AS INTEGER) as fde_monto_ml,
	...
	smn_comercial.smn_pedido_detalle.smn_item_rf as smn_item_rf,
	smn_base.smn_item.itm_nombre as nombre_item
from
	...
	inner join smn_comercial.smn_factura_cabecera on smn_comercial.smn_factura_cabecera.smn_factura_cabecera_id = smn_comercial.smn_rel_pedido_factura.smn_factura_cabecera_id
	inner join smn_base.smn_item on smn_base.smn_item.smn_item_id = smn_comercial.smn_pedido_detalle.smn_item_rf
WHERE
