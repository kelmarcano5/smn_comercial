select  SUM(smn_comercial.smn_presupuesto_detalle.prd_monto_neto_ma) as montomase
		--SUM(smn_comercial.smn_presupuesto_detalle.prd_moneda_alterna+smn_comercial.smn_presupuesto_detalle.prd_monto_incremento_ma-smn_comercial.smn_presupuesto_detalle.prd_monto_descuento_ma) as montomase
	   -- SUM(smn_comercial.smn_presupuesto_detalle.prd_monto_descuento_ma) as descuentoma,
	   -- SUM(smn_comercial.smn_presupuesto_detalle.prd_monto_neto_ma) as netoma2
...
where 
	smn_comercial.smn_presupuesto_detalle.smn_presupuesto_id=${fld:id} and smn_comercial.smn_presupuesto_detalle.smn_tipo_componentes_rf in('SE') and smn_comercial.smn_presupuesto_detalle.prd_estatus<>'RZ'