select smn_comercial.smn_presupuesto_componente.smn_presupuesto_componente_id,
...
smn_comercial.smn_presupuesto_componente.prc_cantidad as pco_cantidad,
smn_comercial.smn_presupuesto_componente.smn_servicios_rf,
smn_comercial.smn_presupuesto_componente.smn_tipos_componentes_rf as pde_naturaleza,
...
smn_comercial.smn_presupuesto_componente.smn_moneda_rf,
smn_comercial.smn_presupuesto_componente.prc_forma_calculo_rf,
smn_comercial.smn_presupuesto_componente.prc_monto_ml as prd_monto_moneda_local,
smn_comercial.smn_presupuesto_componente.prc_monto_ma as prd_moneda_alterna,
smn_comercial.smn_presupuesto_componente.prc_monto_neto_ml,
smn_comercial.smn_presupuesto_componente.prc_monto_neto_ma,
smn_comercial.smn_presupuesto_componente.prc_precio_ml as prd_precio,
smn_comercial.smn_presupuesto_componente.prc_precio_ma as prd_precio_ma,
case
	when smn_comercial.smn_presupuesto_componente.smn_prestadores_servicios_rf IS NULL then 'NO' 
	when smn_comercial.smn_presupuesto_componente.smn_prestadores_servicios_rf IS NOT NULL then 'SI' 
...
from smn_comercial.smn_presupuesto_componente 
...
inner join smn_comercial.smn_presupuesto on smn_comercial.smn_presupuesto.smn_presupuesto_id = smn_comercial.smn_presupuesto_componente.smn_presupuesto_id
where smn_comercial.smn_presupuesto_componente.smn_presupuesto_id = ${fld:smn_presupuesto_id}