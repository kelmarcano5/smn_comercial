select 
	...
	(select smn_comercial.smn_documento.dcf_descripcion from smn_comercial.smn_documento where smn_comercial.smn_documento.smn_documento_id is not null and smn_comercial.smn_documento.smn_documento_id = smn_comercial.smn_presupuesto.smn_documento_id) || ' N° ' || smn_comercial.smn_presupuesto.pre_numero_control as item 
