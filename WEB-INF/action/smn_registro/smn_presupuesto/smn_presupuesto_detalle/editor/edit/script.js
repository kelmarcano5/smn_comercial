...
//document.form1.prd_monto_impuesto_ml.value='${fld:prd_monto_impuesto_ml@#,###,##0.00}';
//document.form1.prd_monto_impuesto_ma.value='${fld:prd_monto_impuesto_ma@#,###,##0.00}';
