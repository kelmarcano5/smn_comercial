...
(
	...
	(select smn_comercial.smn_prestacion_servicio_medico_cabecera.smn_prestacion_servicio_medico_cabecera_id from smn_comercial.smn_prestacion_servicio_medico_cabecera
where smn_comercial.smn_prestacion_servicio_medico_cabecera.smn_ingresos_id=(select smn_comercial.smn_presupuesto.smn_ingresos_id from smn_comercial.smn_presupuesto where smn_comercial.smn_presupuesto.smn_presupuesto_id=${fld:smn_presupuesto_id}) and smn_comercial.smn_prestacion_servicio_medico_cabecera.smn_unidades_servicios_rf=(select smn_base.smn_grupos_prestadores.gpp_unidad_servicio from smn_base.smn_grupos_prestadores where smn_base.smn_grupos_prestadores.smn_grupos_prestadores_id=${fld:smn_grupo_prestador_rf})),
 	0,
	...
	{d '${def:date}'},
	'${def:time}',
	(select smn_comercial.smn_presupuesto.smn_ingresos_id from smn_comercial.smn_presupuesto where smn_comercial.smn_presupuesto.smn_presupuesto_id=${fld:smn_presupuesto_id} limit 1)
