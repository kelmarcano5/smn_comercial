...
(
	...
	(select smn_comercial.smn_rel_centro_fac_documento.smn_documento_id from smn_comercial.smn_centro_facturacion inner join smn_comercial.smn_rel_centro_fac_documento on smn_comercial.smn_rel_centro_fac_documento.smn_centro_facturacion_id = smn_comercial.smn_centro_facturacion.smn_centro_facturacion_id
		where smn_comercial.smn_rel_centro_fac_documento.smn_centro_facturacion_id=${fld:smn_centro_facturacion_id_1}),
	${seq:nextval@smn_comercial.seq_smn_numero_pedido},
	${fld:smn_cliente},
	(select smn_base.smn_usuarios.smn_usuarios_id from smn_base.smn_usuarios LEFT OUTER JOIN smn_seguridad.s_user on smn_seguridad.s_user.user_id = smn_base.smn_usuarios.smn_user_rf where smn_seguridad.s_user.userlogin = '${def:user}'),
	'Pedido Generado Automaticamente desde el punto de venta',
	{d '${def:date}'},
	${fld:smn_entidad_rf},
	${fld:smn_sucursal_rf},
	...
	(select smn_comercial.smn_tipo_linea_comercial.smn_tipo_linea_comercial_id from smn_comercial.smn_tipo_linea_comercial inner join smn_comercial.smn_linea_comercial on smn_comercial.smn_linea_comercial.smn_linea_comercial_id = smn_comercial.smn_tipo_linea_comercial.smn_tipo_linea_comercial_id  inner join smn_comercial.smn_rel_centro_fac_linea on smn_comercial.smn_rel_centro_fac_linea.smn_linea_comercial_id = smn_comercial.smn_linea_comercial.smn_linea_comercial_id where smn_comercial.smn_rel_centro_fac_linea.smn_centro_facturacion_id=${fld:smn_centro_facturacion_id_1}),
