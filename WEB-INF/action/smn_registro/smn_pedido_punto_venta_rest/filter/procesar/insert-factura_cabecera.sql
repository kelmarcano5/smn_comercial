...
(
	...
	(select cfd_ultimo_numero_fiscal_usado+1 from smn_comercial.smn_control_fiscal_documento where smn_comercial.smn_control_fiscal_documento.smn_documento_id=${fld:documento} limit 1),
