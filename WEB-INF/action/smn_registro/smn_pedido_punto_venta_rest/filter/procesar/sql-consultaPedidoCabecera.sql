select
	...
	smn_base.smn_formas_pago.fop_descripcion as formapago
from
	...
	left join smn_comercial.smn_rel_cliente_forma_pago on smn_comercial.smn_rel_cliente_forma_pago.smn_cliente_id = smn_comercial.smn_pedido_cabecera.smn_cliente_id
	left join smn_base.smn_formas_pago on smn_base.smn_formas_pago.smn_formas_pago_id = smn_comercial.smn_rel_cliente_forma_pago.smn_forma_pago_rf
where 
