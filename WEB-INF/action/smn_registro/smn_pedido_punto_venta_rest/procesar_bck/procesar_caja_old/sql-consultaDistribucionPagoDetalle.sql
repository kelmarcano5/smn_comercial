select 
case
	when smn_comercial.smn_cliente.smn_auxiliar_rf is null then comprador.smn_clase_auxiliar_rf
	when smn_comercial.smn_pedido_cabecera.smn_auxiliar_rf is null then smn_comercial.smn_cliente.smn_clase_auxiliar_rf 
...
case
	when smn_comercial.smn_cliente.smn_auxiliar_rf is null then comprador.smn_auxiliar_id
	when comprador.smn_auxiliar_id is null then smn_comercial.smn_cliente.smn_auxiliar_rf 
