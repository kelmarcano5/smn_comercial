...
from
	...
	left outer join smn_base.smn_entidades on smn_base.smn_entidades.smn_entidades_id = smn_comercial.smn_plan_venta.smn_entidades_rf
	...
	left outer join smn_base.smn_almacen on smn_base.smn_almacen.smn_almacen_id = smn_comercial.smn_plan_venta.smn_almacen_rf
	left outer join smn_comercial.smn_documento on smn_comercial.smn_documento.smn_documento_id = smn_comercial.smn_plan_venta.smn_documento_id
...
where
	smn_comercial.smn_plan_venta.smn_plan_venta_id = ${fld:id}
