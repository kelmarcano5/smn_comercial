...
--WHERE
--smn_comercial.smn_rel_linea_comercial_item.smn_linea_comercial_id=${fld:id} and smn_comercial.smn_rel_linea_comercial_item.smn_item_rf=${fld:item} order by smn_base.smn_item.itm_nombre asc