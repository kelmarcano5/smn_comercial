...
smn_comercial.smn_pedido_cabecera.smn_entidad_rf,
 case
  ...
  end as smn_sucursal_rf,
  case
    when smn_comercial.smn_pedido_cabecera.smn_almacen_rf is null then 0 else smn_comercial.smn_pedido_cabecera.smn_almacen_rf
...
where
smn_base.smn_modulos.mod_codigo='CME')
...
where
smn_comercial.smn_pedido_cabecera.smn_pedido_cabecera_id=${fld:smn_pedido_cabecera_id} limit 1)
