...
$('#smn_cliente_id').val(smn_cliente_id).trigger('change');

var smn_documento_id = '${fld:smn_documento_id}';
$('#smn_documento_id').val(smn_documento_id).trigger('change');

var pca_vendedor = '${fld:pca_vendedor}';
$('#pca_vendedor').val(pca_vendedor).trigger('change');

var smn_centro_costo_rf = '${fld:smn_centro_costo_rf}';
$('#smn_centro_costo_rf').val(smn_centro_costo_rf).trigger('change');

var condicion = '${fld:smn_condicion_financiera_rf}';
$('#smn_condicion_financiera_rf').val(condicion).trigger('change');
