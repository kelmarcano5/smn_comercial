UPDATE smn_comercial.smn_factura_detalle SET
	...
	fde_hora='${def:time}',
	fde_impuesto_ml=${fld:fde_impuesto_ml},
	fde_impuesto_ma=${fld:fde_impuesto_ma},
	fde_descuento_ml={fld:fde_descuento_ml},
	fde_descuento_ma={fld:fde_descuento_ma},
	fde_bonificacion=${fld:fde_bonificacion}
