...
document.form1.fde_impuesto_ml.value='${fld:fde_impuesto_ml@#,###,##0.00}';
document.form1.fde_impuesto_ma.value='${fld:fde_impuesto_ma@#,###,##0.00}';
document.form1.fde_descuento_ml.value='${fld:fde_descuento_ml@#,###,##0.00}';
document.form1.fde_descuento_ma.value='${fld:fde_descuento_ma@#,###,##0.00}';
document.form1.fde_bonificacion.value='${fld:fde_bonificacion@#,###,##0.00}'; 
