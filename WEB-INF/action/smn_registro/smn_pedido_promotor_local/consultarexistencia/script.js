...
if (parseInt(cant_pedid) < parseInt(cant_exist)) {
	...
	alertBox ('Cantidad en existencia es igual a 0 desea registrar el pedido igualmente?', '${lbl:b_continue_button}', 'Cancelar', 'pasar_cantidad('+cant_exist+')');
}