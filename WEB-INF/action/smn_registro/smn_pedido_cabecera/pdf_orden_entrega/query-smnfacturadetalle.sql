select
	...
	smn_comercial.smn_pedido_detalle.pde_monto_moneda_alterna/smn_comercial.smn_pedido_detalle.pde_cantidad_aprobada as precio_ma,
	case 
		when smn_comercial.smn_pedido_detalle.smn_item_rf is null then smn_base.smn_servicios.svc_codigo
		when smn_comercial.smn_pedido_detalle.smn_servicios_rf is null then smn_base.smn_item.itm_codigo
	end as codigo_producto,
	case
		when smn_comercial.smn_pedido_cabecera.smn_moneda_rf is null then smn_comercial.smn_pedido_detalle.pde_precio else smn_comercial.smn_pedido_detalle.pde_precio_moneda_alterna
	end as precio,
	case
		when smn_comercial.smn_pedido_cabecera.smn_moneda_rf is null then smn_comercial.smn_pedido_detalle.pde_monto else smn_comercial.smn_pedido_detalle.pde_monto_moneda_alterna
	end as monto
