...
where
	smn_comercial.smn_pedido_cabecera.pca_estatus IN ('GE') --and smn_comercial.smn_pedido_cabecera.pca_fecha_registro= '${def:date}'
	and smn_comercial.smn_tipo_pedido.tpp_codigo IN('03')
ORDER BY smn_comercial.smn_pedido_cabecera.pca_fecha_requerida ASC
