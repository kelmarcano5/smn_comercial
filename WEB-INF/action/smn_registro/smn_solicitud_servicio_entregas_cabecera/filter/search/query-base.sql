select
	...
	smn_comercial.smn_solicitud_servicio_entregas_cabecera.sec_tiempo_sug_preparacion as tiempo,
	smn_comercial.smn_solicitud_servicio_entregas_cabecera.sec_descripcion as descripcion, 
	smn_comercial.smn_solicitud_servicio_entregas_cabecera.sec_monto_ml as monto,
	case
	...
	smn_comercial.smn_documento.doc_codigo||' - '|| smn_comercial.smn_documento.doc_descripcion as smn_documento_id,
	smn_comercial.smn_solicitud_servicio_entregas_cabecera.smn_documento_id as smn_documento_id1,
	...
	smn_comercial.smn_solicitud_servicio_entregas_cabecera.smn_solicitud_servicio_entregas_cabecera_id as numero_documento,
	smn_comercial.smn_documento.doc_descripcion as documento,
...
from
	...
	left outer join smn_base.smn_v_auxiliar on smn_base.smn_v_auxiliar.smn_v_auxiliar_id = smn_comercial.smn_solicitud_servicio_entregas_cabecera.smn_auxiliar_rf
where
	smn_solicitud_servicio_entregas_cabecera_id is not null
	${filter}
order by
