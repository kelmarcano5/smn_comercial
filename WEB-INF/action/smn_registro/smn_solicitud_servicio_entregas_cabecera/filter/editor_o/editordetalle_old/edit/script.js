...
document.form1.sed_precio_ml.value='${fld:sed_precio_ml@######0.00}';
setComboValue('smn_moneda_rf','${fld:smn_moneda_rf}','form1');
document.form1.sed_precio_ma.value='${fld:sed_precio_ma@######0.00}';
document.form1.sed_monto_moneda_local.value='${fld:sed_monto_moneda_local@######0.00}';
document.form1.sed_monto_moneda_alterna.value='${fld:sed_monto_moneda_alterna@######0.00}';
...
<rows>
	...
	var fila ='<input name="smn_ingredientes_id" id="smn_ingredientes_id" type="checkbox" value="'+id+'" style="width:10px" checked>'+item+'<br>';
