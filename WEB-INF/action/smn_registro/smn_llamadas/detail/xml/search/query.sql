select
	...
	smn_comercial.smn_oferta_cabecera.smn_oferta_cabecera_id as smn_oferta_id_combo,
...
from
	...
	inner join smn_comercial.smn_gestion on smn_comercial.smn_gestion.smn_gestion_id = smn_comercial.smn_llamadas.smn_gestion_id
	inner join smn_comercial.smn_prospecto on smn_comercial.smn_prospecto.smn_prospecto_id = smn_comercial.smn_llamadas.smn_prospecto_id
	inner join smn_comercial.smn_cliente on smn_comercial.smn_cliente.smn_cliente_id = smn_comercial.smn_llamadas.smn_cliente_id
	inner join smn_base.smn_auxiliar on smn_base.smn_auxiliar.smn_auxiliar_id = smn_comercial.smn_cliente.smn_auxiliar_rf
	inner join smn_comercial.smn_oferta_cabecera on smn_comercial.smn_oferta_cabecera.smn_oferta_cabecera_id = smn_comercial.smn_llamadas.smn_oferta_id
