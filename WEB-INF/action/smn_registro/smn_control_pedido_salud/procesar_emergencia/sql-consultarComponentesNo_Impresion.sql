SELECT DISTINCT
	...
	case
	when smn_comercial.smn_pedido_componentes.pco_tipo_componente='HO' then smn_base.smn_componentes.cmp_descripcion ||' - '|| COALESCE(smn_base.smn_auxiliar.aux_rif, '') 
...
where 
	...
	and smn_comercial.smn_pedido_componentes.pco_imprime='N'