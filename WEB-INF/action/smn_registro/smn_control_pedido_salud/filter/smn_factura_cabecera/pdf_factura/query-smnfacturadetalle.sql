...
from
	...
	left JOIN	
		smn_comercial.smn_factura_cabecera on smn_comercial.smn_factura_impresion_detalle.smn_factura_cabecera_id = smn_comercial.smn_factura_cabecera.smn_factura_cabecera_id
	INNER JOIN 
