select DISTINCT
	...
	case
		when smn_comercial.smn_pedido_cabecera.pca_estatus='PR' then 'Procesada'
	...
	smn_comercial.smn_tipo_linea_comercial.tlc_nombre as smn_tipo_linea_comercial_id1,
	...
	smn_comercial.smn_pedido_cabecera.pca_monto_neto_ma as montoma,
	...
	smn_comercial.smn_pedido_cabecera.smn_linea_comercial_id as linea,
	...
	promotor.aux_descripcion as promotor,
	case
	...
	smn_caja.smn_mov_caja_cabecera.mcc_doc_referencia as ticket,
	smn_caja.smn_mov_caja_cabecera.mcc_documento_numero as num_caja,
	smn_caja.smn_mov_caja_cabecera.smn_mov_caja_cabecera_id as caja_id,
	case
		when smn_comercial.smn_pedido_cabecera.pca_segmentada='SI' then '${lbl:b_yes}'
		when smn_comercial.smn_pedido_cabecera.pca_segmentada is null then 'NO' ELSE '${lbl:b_not}'
	end as pca_segmentada,
	smn_salud.smn_tipo_documento.tdc_codigo as documento_salud,
...
from
	...
	left join smn_salud.smn_documento doc_sal on doc_sal.smn_documento_id = (select smn_documento_id from smn_salud.smn_ingresos where smn_salud.smn_ingresos.igs_num_ingreso=smn_caja.smn_mov_caja_cabecera.smn_num_doc_origen_rf)
	left join smn_salud.smn_tipo_documento on smn_salud.smn_tipo_documento.smn_tipo_documento_id = doc_sal.smn_tipo_documento_id
	left join smn_cobranzas.smn_mov_documento_cob_cab on smn_cobranzas.smn_mov_documento_cob_cab.mdc_numero_doc_origen = smn_comercial.smn_pedido_cabecera.pca_numero_pedido
...
where
	smn_comercial.smn_pedido_cabecera.pca_estatus IN ('RE','PR') --and smn_comercial.smn_pedido_cabecera.pca_fecha_registro= '${def:date}'
	--and smn_comercial.smn_tipo_pedido.tpp_codigo IN('03')
ORDER BY smn_comercial.smn_pedido_cabecera.pca_fecha_registro desc
