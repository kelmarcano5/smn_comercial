UPDATE smn_cobranzas.smn_saldo_cliente SET
	...
	scl_hora='${def:time}',
	scl_monto_doc_registrados_ml=(scl_monto_doc_registrados_ml + ${fld:scl_debitos_ml} + ${fld:scl_creditos_ml}),
	scl_monto_doc_registrados_ma=(scl_monto_doc_registrados_ma + ${fld:scl_debitos_ma} + ${fld:scl_creditos_ma})
WHERE
