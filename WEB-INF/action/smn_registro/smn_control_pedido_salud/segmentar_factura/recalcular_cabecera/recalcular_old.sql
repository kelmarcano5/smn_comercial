...
select 
	case
		...
		case
		when SUM(smn_comercial.smn_pedido_detalle.pde_precio_moneda_alterna) is null then 0 else SUM(smn_comercial.smn_pedido_detalle.pde_precio_moneda_alterna) 
	end as monto_ma,
			case
