...
from
	...
	inner join smn_base.smn_codigos_impuestos on smn_base.smn_codigos_impuestos.smn_codigos_impuestos_id = smn_comercial.smn_factura_impuestos.smn_codigos_impuestos_rf
	inner join smn_base.smn_monedas on smn_base.smn_monedas.smn_monedas_id = smn_comercial.smn_factura_impuestos.smn_moneda_rf
	inner join smn_base.smn_tasas_de_cambio on smn_base.smn_tasas_de_cambio.smn_tasas_de_cambio_id = smn_comercial.smn_factura_impuestos.smn_tasa_rf
where 
	smn_comercial.smn_factura_impuestos.smn_factura_detalle_id=${fld:id2}