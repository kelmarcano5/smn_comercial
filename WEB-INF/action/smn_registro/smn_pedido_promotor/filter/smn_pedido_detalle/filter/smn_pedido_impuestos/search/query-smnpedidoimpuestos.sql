...
from
	...
	left join smn_base.smn_monedas on smn_base.smn_monedas.smn_monedas_id = smn_comercial.smn_pedido_impuestos.smn_moneda_rf
	left join smn_base.smn_tasas_de_cambio on smn_base.smn_tasas_de_cambio.smn_tasas_de_cambio_id = smn_comercial.smn_pedido_impuestos.smn_tasa_rf
where
	smn_comercial.smn_pedido_impuestos.smn_pedido_detalle_id=${fld:id2}