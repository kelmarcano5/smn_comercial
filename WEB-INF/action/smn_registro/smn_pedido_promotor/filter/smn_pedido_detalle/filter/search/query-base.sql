select
	...
	smn_comercial.smn_pedido_detalle.pde_monto_neto_ml,
	smn_comercial.smn_pedido_detalle.pde_monto_neto_ma,
...
where
	smn_comercial.smn_pedido_detalle.smn_pedido_detalle_id is not null and smn_comercial.smn_pedido_detalle.smn_pedido_cabecera_id=${fld:id2}
	${filter}
order by
	smn_comercial.smn_pedido_detalle.smn_pedido_detalle_id
