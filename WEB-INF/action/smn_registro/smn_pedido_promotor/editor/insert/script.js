...
console.log("Tipo Tasa del formulario el tipo hidden: "+tipotasa);
//
...
function goTodetail(id_cab) {
	...
	uri = "${def:context}${def:actionroot}/../editor_det/form?id2="+id_cab+"&despacho="+despacho+"&fecha_requerida="+fecha_req+"&tipotasa="+tipotasa+"&baremos="+baremos;
