select
	...
	case
		when smn_comercial.smn_pedido_cabecera.smn_cliente_id = 0 then smn_base.smn_auxiliar.aux_rif else cli.aux_rif
	end as rif
from
	...
	left join smn_base.smn_auxiliar on smn_base.smn_auxiliar.smn_auxiliar_id = 	smn_comercial.smn_pedido_cabecera.smn_auxiliar_rf
