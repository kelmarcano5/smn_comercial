...
(
	...
	(select case when smn_comercial.smn_pedido_cabecera.smn_auxiliar_rf = 0 then smn_comercial.smn_pedido_cabecera.smn_cliente_id when smn_comercial.smn_pedido_cabecera.smn_cliente_id  = 0 then smn_comercial.smn_pedido_cabecera.smn_auxiliar_rf end as cliente from smn_comercial.smn_pedido_cabecera where smn_comercial.smn_pedido_cabecera.smn_pedido_cabecera_id=${fld:smn_pedido_cabecera_id}),
