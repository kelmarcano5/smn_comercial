...
$("#tabla5").append('<tr><td align="left">'+forma+'</td><td align="center">'+num_aut+'</td><td align="right">'+doc_ident+'</td><td align="right">'+nom_pag+'</td><td align="right">'+mont_pagar+'</td><td align="right">'+mont_pago+'</td><td align="right">'+mont_dev+'</td><td align="right">'+mont_pagar_ma+'</td><td align="right">'+mont_pago_ma+'</td><td align="right">'+mont_dev_ma+'</td></tr>');
