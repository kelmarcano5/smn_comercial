...
(select SUM(smn_comercial.smn_pedido_detalle.pde_cantidad_pedido) from smn_comercial.smn_pedido_detalle where smn_comercial.smn_pedido_detalle.smn_pedido_cabecera_id=${fld:smn_pedido_cabecera_id}) as cantidad,
(select SUM(smn_comercial.smn_pedido_detalle.pde_monto) from smn_comercial.smn_pedido_detalle where smn_comercial.smn_pedido_detalle.smn_pedido_cabecera_id=${fld:smn_pedido_cabecera_id}) as monto_pedido_cabecera,
(select SUM(smn_comercial.smn_pedido_detalle.pde_monto_moneda_alterna) from smn_comercial.smn_pedido_detalle where smn_comercial.smn_pedido_detalle.smn_pedido_cabecera_id=${fld:smn_pedido_cabecera_id}) as monto_pedido_cabecera_ma
