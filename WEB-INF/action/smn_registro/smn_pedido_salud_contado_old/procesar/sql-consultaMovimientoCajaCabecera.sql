select cliente.smn_v_auxiliar_id as cliente1,
	...
	case
		when smn_comercial.smn_pedido_cabecera.smn_auxiliar_rf is null then cliente.smn_v_auxiliar_id
		when cliente.smn_v_auxiliar_id is null then smn_comercial.smn_pedido_cabecera.smn_auxiliar_rf
	end as cliente
from 
