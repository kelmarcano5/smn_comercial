...
select
  ...
  'Ventas al Detal',
	'NO',
  case
    when smn_inventario.smn_caracteristica_item.smn_unidad_medida_venta_rf is null then 0 else smn_inventario.smn_caracteristica_item.smn_unidad_medida_venta_rf
  end as smn_unidad_medida_venta_rf,
