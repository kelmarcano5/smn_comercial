...
where smn_base.smn_baremos_detalle.bad_estatus='A' AND smn_comercial.smn_rel_linea_comercial_servicio.smn_linea_comercial_id=${fld:id} ORDER BY smn_base.smn_servicios.smn_servicios_id  ASC
