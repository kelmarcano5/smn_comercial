select
	...
	case
		...
		when smn_comercial.smn_orden_servicio_detalle.osd_estatus='SO' then 'Solicitado'
		...
		when smn_comercial.smn_orden_servicio_detalle.osd_estatus='DP' then 'Despachado'
...
where
	smn_comercial.smn_orden_servicio_detalle.smn_orden_cab_det_servicio_id=${fld:id2}
