select DISTINCT
	...
	smn_inventario.smn_caracteristica_item.smn_centro_costo_rf as smn_centro_costo_rf,
	smn_inventario.smn_caracteristica_item.smn_unidad_medida_almacenamiento_rf as smn_unidad_medida_rf,
	smn_inventario.smn_control_item.coi_valor_final as mde_valor_unitario_ml,
	smn_inventario.smn_control_item.coi_valor_final_ma as mde_valor_unitario_ma,
	smn_base.smn_item.itm_nombre as mde_descripcion
from
...
where 
	smn_comercial.smn_orden_cab_det_servicio.smn_orden_servicio_id =${fld:id2} and smn_comercial.smn_orden_servicio_detalle.osd_estatus='RC'