select
	...
	smn_base.smn_nivel_estructura.nes_nombre as smn_nivel_estructura_rf,
	smn_comercial.smn_orden_servicio_detalle.osd_fecha_registro
	
from
	smn_comercial.smn_orden_servicio_detalle
	left join smn_base.smn_servicios on smn_base.smn_servicios.smn_servicios_id = smn_comercial.smn_orden_servicio_detalle.smn_servicios_rf
...
where
	smn_comercial.smn_orden_servicio_detalle.smn_servicios_rf=${fld:servicio} and smn_comercial.smn_orden_servicio_detalle.smn_orden_cab_det_servicio_id=${fld:id2} and smn_comercial.smn_orden_servicio_detalle.smn_tipo_componente IN ('IT')