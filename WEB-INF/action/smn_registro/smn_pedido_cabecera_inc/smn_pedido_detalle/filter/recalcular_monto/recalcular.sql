...
pca_monto_impuesto_ml=rows.pde_monto_impuesto_ml,
pca_monto_descuento_ml=rows.pde_descuento_ml,
pca_monto_impuesto_ma=rows.pde_monto_impuesto_ma,
pca_monto_descuento_ma=rows.pde_monto_descuento_ma,
...
smn_moneda_rf=(select smn_comercial.smn_pedido_detalle.smn_moneda_rf from smn_comercial.smn_pedido_detalle where smn_comercial.smn_pedido_detalle.smn_pedido_cabecera_id=${fld:id2} limit 1),
smn_tasa_rf=(select smn_comercial.smn_pedido_detalle.smn_tasa_rf from smn_comercial.smn_pedido_detalle where smn_comercial.smn_pedido_detalle.smn_pedido_cabecera_id=${fld:id2} limit 1)
from rows
where
