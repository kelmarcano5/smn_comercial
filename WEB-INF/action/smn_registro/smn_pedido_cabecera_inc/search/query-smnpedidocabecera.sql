...
from
	...
	left join smn_comercial.smn_centro_facturacion on smn_comercial.smn_centro_facturacion.smn_centro_facturacion_id = smn_comercial.smn_pedido_cabecera.smn_centro_facturacion_id
	left join smn_comercial.smn_sub_centro_facturacion on smn_comercial.smn_sub_centro_facturacion.smn_sub_centro_facturacion_id = smn_comercial.smn_pedido_cabecera.smn_sub_centro_facturacion_id
	left join smn_comercial.smn_tipo_linea_comercial on smn_comercial.smn_tipo_linea_comercial.smn_tipo_linea_comercial_id = smn_comercial.smn_pedido_cabecera.smn_tipo_linea_comercial_id
	left join smn_comercial.smn_linea_comercial on smn_comercial.smn_linea_comercial.smn_linea_comercial_id = smn_comercial.smn_pedido_cabecera.smn_linea_comercial_id
	...
	left join smn_base.smn_auxiliar promo on promo.smn_auxiliar_id= smn_comercial.smn_pedido_cabecera.pca_vendedor
where
	smn_comercial.smn_pedido_cabecera.pca_estatus IN ('PR','RE') and smn_comercial.smn_pedido_cabecera.smn_entidad_rf=${fld:entidades} and smn_comercial.smn_pedido_cabecera.smn_centro_facturacion_id=${fld:centro_facturacion}
	and smn_comercial.smn_tipo_pedido.tpp_codigo IN('03','05','01')
