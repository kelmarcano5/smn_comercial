...
where
	smn_pedido_cabecera_id is not null and smn_comercial.smn_pedido_cabecera.smn_entidad_rf=${fld:entidades}
	and smn_comercial.smn_tipo_pedido.tpp_codigo IN('03')
	${filter}
order by smn_comercial.smn_pedido_cabecera.pca_fecha_registro, smn_comercial.smn_pedido_cabecera.pca_numero_pedido DESC
