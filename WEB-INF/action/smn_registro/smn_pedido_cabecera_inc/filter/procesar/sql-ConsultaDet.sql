select 
	...
	case 
		when smn_comercial.smn_pedido_detalle.pde_monto_neto_ml is null then 0 else smn_comercial.smn_pedido_detalle.pde_monto_neto_ml
	end as mdd_monto_ml,
	case 
		when smn_comercial.smn_pedido_detalle.pde_monto_neto_ma is null then 0 else smn_comercial.smn_pedido_detalle.pde_monto_neto_ma
	 end as mdd_monto_ma,
	case 
		when smn_comercial.smn_pedido_cabecera.pca_monto_neto_ml is null then 0 else smn_comercial.smn_pedido_detalle.pde_monto_neto_ml
	end as mdd_saldo_ml,
	case 
		when smn_comercial.smn_pedido_cabecera.pca_monto_neto_ma is null then 0 else smn_comercial.smn_pedido_detalle.pde_monto_neto_ma
	end as mdd_saldo_ma
