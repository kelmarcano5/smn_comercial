select 
	cliente.smn_v_auxiliar_id as cliente,
	cliente.smn_clase_id as clase,
	smn_comercial.smn_centro_facturacion.smn_caja_rf as caja,
	smn_comercial.smn_pedido_cabecera.pca_monto_neto_ml as monto_ml,
	smn_comercial.smn_pedido_cabecera.pca_monto_neto_ml as saldo_ml,
	smn_comercial.smn_pedido_cabecera.pca_monto_neto_ma as monto_ma,
	...
	smn_comercial.smn_pedido_cabecera.pca_estatus_pago as estatus_pago
from 
