select
	...
	(select smn_base.smn_auxiliar_cond_financiera.cfn_codigo|| ' - ' || smn_base.smn_auxiliar_cond_financiera.cfn_descripcion from  smn_base.smn_auxiliar_cond_financiera  where smn_base.smn_auxiliar_cond_financiera.smn_auxiliar_cond_financiera_id is not null  and smn_base.smn_auxiliar_cond_financiera.smn_auxiliar_cond_financiera_id=smn_comercial.smn_cliente.smn_condicion_financiera_rf  order by cfn_descripcion ) as smn_condicion_financiera_rf_combo,
	...
	smn_comercial.smn_cliente.smn_condicion_financiera_rf,
