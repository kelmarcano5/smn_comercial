...
where
	smn_rel_cliente_entidad_financiera_id is not null
	and 	smn_comercial.smn_cliente.smn_cliente_id=smn_comercial.smn_rel_cliente_entidad_financiera.smn_cliente_id
	${filter}
order by
