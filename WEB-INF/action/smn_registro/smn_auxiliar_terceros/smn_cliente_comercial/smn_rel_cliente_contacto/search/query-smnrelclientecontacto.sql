select
	...
	smn_base.smn_auxiliar_contacto.smn_tipo_contactos_rf ||' - '|| smn_base.smn_auxiliar_contacto.auc_descripcion as smn_contacto_rf,
	smn_base.smn_clase_auxiliar.cla_codigo as codigo_aux,
smn_base.smn_clase_auxiliar.cla_nombre as descripcion_aux
from
...
where
	smn_comercial.smn_rel_cliente_contacto.smn_cliente_id=${fld:id2}
