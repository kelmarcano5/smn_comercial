...
left join smn_base.smn_tipos_servicios on smn_base.smn_tipos_servicios.smn_tipos_servicios_id = smn_comercial.smn_orden_servicio.smn_tipo_servicio_rf
...
where 
	smn_comercial.smn_orden_servicio.ors_estatus='GE'