...
from
	...
	INNER JOIN
		smn_comercial.smn_factura_impresion_detalle on smn_comercial.smn_factura_cabecera.smn_factura_cabecera_id = smn_comercial.smn_factura_impresion_detalle.smn_factura_cabecera_id
	INNER JOIN
	...
	LEFT JOIN 
        smn_comercial.smn_rel_pedido_factura on  smn_comercial.smn_rel_pedido_factura.smn_factura_cabecera_id = smn_comercial.smn_factura_cabecera.smn_factura_cabecera_id
where
    smn_comercial.smn_factura_impresion_detalle.smn_factura_cabecera_id=${fld:id}
