...
(
	...
	${fld:entidad},
	${fld:sucursal},
	(select cfd_numero_documento_fiscal_inicial from smn_comercial.smn_control_fiscal_documento where smn_comercial.smn_control_fiscal_documento.smn_control_fiscal_documento_id=4 limit 1),
	(select cfd_ultimo_numero_fiscal_usado+1 from smn_comercial.smn_control_fiscal_documento where smn_comercial.smn_control_fiscal_documento.smn_control_fiscal_documento_id=4 limit 1),
