select
	...
	smn_comercial.smn_pedido_detalle.pde_precio * smn_comercial.smn_pedido_detalle.pde_cantidad_pedido as pde_monto,
...
from
	...
	left outer join smn_base.smn_auxiliar paciente on paciente.smn_auxiliar_id = smn_caja.smn_mov_caja_cabecera.smn_auxiliar_rf
	left outer join smn_base.smn_auxiliar cliente on cliente.smn_auxiliar_id = smn_caja.smn_mov_caja_cabecera.smn_auxiliar_pagador_rf
where
	smn_comercial.smn_pedido_detalle.smn_pedido_detalle_id is not null 
	--and smn_comercial.smn_pedido_detalle.smn_pedido_cabecera_id=${fld:id2}
	${filter}
