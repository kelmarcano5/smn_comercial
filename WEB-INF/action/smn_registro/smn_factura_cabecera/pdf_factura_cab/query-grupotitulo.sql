...
FROM
	...
	INNER JOIN smn_comercial.smn_factura_impresion_detalle ON smn_comercial.smn_factura_cabecera.smn_factura_cabecera_id = smn_comercial.smn_factura_impresion_detalle.smn_factura_cabecera_id
...
WHERE
	smn_comercial.smn_rel_pedido_factura.smn_factura_cabecera_id = ${fld:id}
