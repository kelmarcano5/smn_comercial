SELECT
smn_comercial.smn_pedido_cabecera.pca_fecha_requerida, sum(smn_comercial.smn_pedido_detalle.pde_monto) as pca_monto_neto_ml,
smn_comercial.smn_pedido_cabecera.pca_fecha_requerida as pca_fecha_requerida_h, smn_comercial.smn_pedido_cabecera.smn_entidad_rf
...
WHERE smn_comercial.smn_pedido_cabecera.smn_pedido_cabecera_id is not null
 	 ${filter}
GROUP BY smn_comercial.smn_pedido_cabecera.pca_fecha_requerida, smn_comercial.smn_pedido_cabecera.smn_entidad_rf
