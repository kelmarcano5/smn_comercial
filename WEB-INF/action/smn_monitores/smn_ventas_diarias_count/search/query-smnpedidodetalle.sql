SELECT
smn_comercial.smn_pedido_detalle.smn_catalogo_item_comercio_id,
smn_base.smn_item.itm_nombre as smn_item,
count(*) as pde_monto
--,
--sum(smn_comercial.smn_pedido_detalle.pde_monto) as pde_monto
...
WHERE smn_comercial.smn_pedido_cabecera.smn_pedido_cabecera_id is not null AND smn_comercial.smn_pedido_detalle.smn_catalogo_item_comercio_id is not null and
 	smn_comercial.smn_pedido_cabecera.smn_entidad_rf = ${fld:smn_entidad_rf} and
 	smn_comercial.smn_pedido_cabecera.pca_fecha_requerida<=${fld:pca_fecha_requerida_h} and
 	smn_comercial.smn_pedido_cabecera.pca_fecha_requerida>=${fld:pca_fecha_requerida}
GROUP BY smn_comercial.smn_pedido_detalle.smn_catalogo_item_comercio_id, smn_base.smn_item.itm_nombre