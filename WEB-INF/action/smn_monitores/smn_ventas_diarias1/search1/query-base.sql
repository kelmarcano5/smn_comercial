SELECT
smn_comercial.smn_pedido_cabecera.pca_fecha_registro, sum(smn_comercial.smn_pedido_detalle.pde_monto) as pca_monto_neto_ml
...
WHERE smn_comercial.smn_pedido_cabecera.smn_pedido_cabecera_id is not null
	AND smn_comercial.smn_pedido_detalle.smn_catalogo_item_comercio_id is not null 	
 	 ${filter}
GROUP BY smn_comercial.smn_pedido_cabecera.pca_fecha_registro
ORDER BY smn_comercial.smn_pedido_cabecera.pca_fecha_registro;