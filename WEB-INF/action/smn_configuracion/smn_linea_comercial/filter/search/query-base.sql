...
where
	smn_linea_comercial_id is not null
	and 	smn_comercial.smn_tipo_linea_comercial.smn_tipo_linea_comercial_id=smn_comercial.smn_linea_comercial.smn_tipo_linea_comercial_id
	${filter}
order by
