...
from
	...
	smn_comercial.smn_rel_linea_comercial_servicio
where
	smn_rel_linea_comercial_servicio_id is not null
	and 	smn_comercial.smn_linea_comercial.smn_linea_comercial_id=smn_comercial.smn_rel_linea_comercial_servicio.smn_linea_comercial_id
	${filter}
order by
