...
where
	smn_comercial.smn_cliente.smn_cliente_id=smn_comercial.smn_rel_cliente_area_interes.smn_cliente_id and
	smn_comercial.smn_area_interes.smn_area_interes_id=smn_comercial.smn_rel_cliente_area_interes.smn_area_interes_id
	and
