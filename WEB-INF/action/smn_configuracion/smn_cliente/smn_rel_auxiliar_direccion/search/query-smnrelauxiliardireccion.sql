select
	...
	smn_base.smn_auxiliar.aux_descripcion as smn_auxiliar_id_combo,
...
from
	...
	INNER JOIN smn_comercial.smn_cliente on smn_comercial.smn_cliente.smn_cliente_id = 	smn_base.smn_rel_auxiliar_direccion.smn_auxiliar_id
...
where 
	smn_base.smn_rel_auxiliar_direccion.smn_auxiliar_id=${fld:id2} 