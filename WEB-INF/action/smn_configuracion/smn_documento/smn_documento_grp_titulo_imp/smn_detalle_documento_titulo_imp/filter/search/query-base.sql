...
where
	smn_detalle_documento_titulo_imp_id is not null
	and 	smn_comercial.smn_documento_grp_titulo_imp.smn_documento_grp_titulo_imp_id=smn_comercial.smn_detalle_documento_titulo_imp.smn_documento_grp_titulo_imp_id
	${filter}
order by
