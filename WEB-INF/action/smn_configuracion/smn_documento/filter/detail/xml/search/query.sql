select
	...
	case
		when smn_comercial.smn_documento.dcf_req_servicios='SI' then '${lbl:b_yes}'
		when smn_comercial.smn_documento.dcf_req_servicios='NO' then '${lbl:b_not}'
	end as dcf_req_servicios,
	case
...
where
	smn_comercial.smn_tipo_documentos_fact.smn_tipo_documentos_fact_id=smn_comercial.smn_documento.smn_tipo_documentos_fact_id
	and
