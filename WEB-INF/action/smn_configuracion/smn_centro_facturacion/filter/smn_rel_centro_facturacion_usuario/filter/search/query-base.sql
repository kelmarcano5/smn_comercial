...
where
	smn_rel_centro_facturacion_usuario_id is not null
	and 	smn_comercial.smn_centro_facturacion.smn_centro_facturacion_id=smn_comercial.smn_rel_centro_facturacion_usuario.smn_centro_facturacion_id
	${filter}
order by
