...
from
	...
	inner join smn_compras.smn_proveedor on smn_compras.smn_proveedor.smn_proveedor_id = smn_comercial.smn_control_fiscal_documento.smn_proveedor_rf
...
where
	smn_control_fiscal_documento_id is not null
	${filter}
order by
