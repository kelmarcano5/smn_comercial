...
from
	...
	inner join smn_comercial.smn_pedido_detalle on smn_comercial.smn_pedido_detalle.smn_pedido_detalle_id = smn_comercial.smn_ingredientes.smn_pedido_detalle_id
	left outer join smn_base.smn_monedas on smn_base.smn_monedas.smn_monedas_id = smn_comercial.smn_ingredientes.smn_moneda_rf

where
	smn_comercial.smn_pedido_detalle.smn_pedido_detalle_id=smn_comercial.smn_ingredientes.smn_pedido_detalle_id
	and
