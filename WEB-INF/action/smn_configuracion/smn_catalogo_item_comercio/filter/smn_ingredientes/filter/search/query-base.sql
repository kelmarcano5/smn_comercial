...
where
	smn_ingredientes_id is not null
	and 	smn_comercial.smn_solicitud_servicio_entregas_detalle.smn_solicitud_servicio_entregas_detalle_id=smn_comercial.smn_ingredientes.smn_solicitud_servicio_entregas_detalle_id
	${filter}
order by
		smn_ingredientes_id
