select
	...
	smn_comercial.smn_catalogo_item_comercio.cic_descripcion,
...
from
	...
	left outer join smn_base.smn_unidad_medida on smn_base.smn_unidad_medida.smn_unidad_medida_id = smn_comercial.smn_catalogo_item_comercio.smn_unidad_medida_rf
where
