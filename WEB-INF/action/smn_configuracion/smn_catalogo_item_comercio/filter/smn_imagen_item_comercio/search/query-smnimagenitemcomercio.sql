select
	...
	smn_comercial.smn_imagen_item_comercio.smn_imagen_item_comercio_id as id,
...
where
	upper (content_type) like upper('%image%') and smn_comercial.smn_catalogo_item_comercio.smn_catalogo_item_comercio_id=${fld:id2}
order by 
	smn_comercial.smn_imagen_item_comercio.smn_imagen_item_comercio_id
