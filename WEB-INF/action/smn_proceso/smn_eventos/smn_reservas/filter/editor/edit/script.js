...
setComboValue('res_asiconexp','${fld:res_asiconexp}','form1');
setComboValue('res_asiconpro','${fld:res_asiconpro}','form1');
setComboValue('res_asiconaud','${fld:res_asiconaud}','form1');
