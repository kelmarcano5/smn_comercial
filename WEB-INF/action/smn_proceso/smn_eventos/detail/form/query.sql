select
	...
	smn_comercial.smn_evento.eve_cupo,
	smn_comercial.smn_evento.eve_reservas_por_afiliado,
...
from
	...
	inner join smn_base.smn_clasificacion_abc on smn_base.smn_clasificacion_abc.smn_clasificacion_abc_id = smn_comercial.smn_evento.smn_clasificacion_abc_rf
where
