...
smn_comercial.smn_pedido_cabecera.pca_monto_pedido_ml as monto_pedido,
	...
	smn_comercial.smn_pedido_detalle.pde_observaciones as requisitos, 
	...
	smn_comercial.smn_pedido_detalle.pde_especificaciones_pedido as extras,
...
where
	smn_comercial.smn_pedido_detalle.smn_pedido_cabecera_id is not null
and 
	smn_comercial.smn_pedido_cabecera.pca_estatus IN ('GE')
	${filter}
order by smn_comercial.smn_pedido_cabecera.pca_fecha_registro, smn_comercial.smn_pedido_cabecera.smn_pedido_cabecera_id ASC
