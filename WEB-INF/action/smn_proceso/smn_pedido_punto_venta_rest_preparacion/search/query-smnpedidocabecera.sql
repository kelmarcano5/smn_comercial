select DISTINCT
	...
	smn_comercial.smn_pedido_cabecera.pca_tiempo_sug_preparacion as tiempo_preparacion,
...
where
	smn_comercial.smn_pedido_cabecera.pca_estatus ='EP'
group by smn_comercial.smn_pedido_cabecera.smn_pedido_cabecera_id, smn_comercial.smn_pedido_cabecera.pca_monto_pedido_ml,
smn_comercial.smn_pedido_cabecera.pca_estatus, smn_comercial.smn_pedido_cabecera.pca_estatus_pago, smn_comercial.smn_documento.dcf_codigo, smn_comercial.smn_documento.dcf_descripcion,
smn_comercial.smn_pedido_cabecera.pca_numero_pedido, smn_comercial.smn_pedido_cabecera.pca_descripcion, smn_comercial.smn_centro_facturacion.cfc_nombre, smn_comercial.smn_sub_centro_facturacion.scf_nombre, smn_comercial.smn_tipo_linea_comercial.tlc_nombre, smn_comercial.smn_linea_comercial.lco_nombre, smn_comercial.smn_pedido_cabecera.pca_fecha_registro, smn_comercial.smn_pedido_cabecera.pca_numero_pedido, smn_comercial.smn_pedido_cabecera.smn_sucursal_rf, smn_comercial.smn_pedido_cabecera.smn_entidad_rf,
smn_comercial.smn_pedido_cabecera.smn_cliente_id, smn_comercial.smn_pedido_cabecera.smn_documento_id, smn_comercial.smn_cliente.smn_auxiliar_rf, smn_comercial.smn_pedido_cabecera.pca_monto_neto_ml, smn_comercial.smn_pedido_cabecera.pca_estatus, smn_comercial.smn_pedido_cabecera.smn_pedido_cabecera_id, smn_comercial.smn_documento.dcf_descripcion, smn_comercial.smn_pedido_detalle.pde_especificaciones_pedido, smn_comercial.smn_pedido_detalle.pde_tiempo_sug_preparacion, smn_comercial.smn_pedido_cabecera.pca_hora_inicio_preparacion, smn_comercial.smn_pedido_cabecera.pca_hora_inicio_preparacion, smn_comercial.smn_pedido_detalle.pde_observaciones, smn_comercial.smn_pedido_cabecera.pca_fecha_registro, 
smn_comercial.smn_documento.smn_documento_id, comp.aux_descripcion, smn_comercial.smn_pedido_cabecera.pca_cantidad, it.itm_nombre, smn_comercial.smn_pedido_detalle.smn_descripcion_ingrediente,smn_base.smn_auxiliar.aux_descripcion, smn_comercial.smn_pedido_cabecera.pca_tiempo_sug_preparacion
