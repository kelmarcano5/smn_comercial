select
	...
	smn_comercial.smn_reservas.res_asiconexp,
	smn_comercial.smn_reservas.res_asiconpro,
	smn_comercial.smn_reservas.res_asiconaud,
...
where
	smn_comercial.smn_reservas.smn_afiliado_id=${fld:id2}