select
	...
	smn_base.smn_auxiliar.aux_descripcion as rel_auxiliar_rf,
...
from
	...
	inner join smn_comercial.smn_afiliados on smn_comercial.smn_afiliados.smn_afiliados_id = smn_comercial.smn_relacionado.smn_afiliados_id
where
	smn_comercial.smn_relacionado.smn_afiliados_id=${fld:id2}