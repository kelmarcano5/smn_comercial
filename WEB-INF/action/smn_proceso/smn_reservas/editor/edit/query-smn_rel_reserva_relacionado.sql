select  smn_comercial.smn_relacionado.smn_relacionado_id as smn_relacionado_id, smn_base.smn_auxiliar.aux_nombres ||' '|| smn_base.smn_auxiliar.aux_apellidos as item from smn_comercial.smn_rel_reserva_relacionado 
...
where smn_comercial.smn_rel_reserva_relacionado.smn_reservas_id=${fld:id}