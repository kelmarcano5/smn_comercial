select
	...
	smn_comercial.smn_pedido_cabecera.smn_pedido_cabecera_id as pedidoid,
		smn_comercial.smn_pedido_cabecera.pca_monto as monto,
	smn_comercial.smn_pedido_cabecera.pca_cantidad * smn_comercial.smn_pedido_cabecera.pca_monto as montoneto
...
from
	...
	inner join smn_comercial.smn_pedido_pagadores on smn_comercial.smn_pedido_pagadores.smn_pedido_cabecera_id = smn_comercial.smn_pedido_cabecera.smn_pedido_cabecera_id
...
WHERE smn_comercial.smn_pedido_cabecera.smn_pedido_cabecera_id = ${fld:smn_pedido_cabecera_id} AND
	  pca_estatus = 'RE' AND   	--que este pendiente
	  pca_fecha_registro = current_date -- y que la fecha de generacion se la actual
LIMIT 1
