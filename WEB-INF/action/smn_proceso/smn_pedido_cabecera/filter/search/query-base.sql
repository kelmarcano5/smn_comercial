select
	...
	smn_seguridad.s_user.fname ||' - '|| 	smn_seguridad.s_user.lname as smn_usuario_rf_combo,
...
from
	...
	inner join smn_base.smn_usuarios on smn_base.smn_usuarios.smn_usuarios_id = smn_comercial.smn_pedido_cabecera.smn_usuario_rf 
