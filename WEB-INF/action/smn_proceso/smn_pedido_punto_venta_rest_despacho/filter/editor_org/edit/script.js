...
document.form1.pca_monto_pedido_ml.value='${fld:pca_monto_pedido_ml@#,###,###0.00}';
document.form1.pca_monto_impuesto_ml.value='${fld:pca_monto_impuesto_ml@#,###,###0.00}';
document.form1.pca_monto_descuento_ml.value='${fld:pca_monto_descuento_ml@#,###,###0.00}';
document.form1.pca_monto_bonificacion_ml.value='${fld:pca_monto_bonificacion_ml@#,###,###0.00}';
document.form1.pca_monto_neto_ml.value='${fld:pca_monto_neto_ml@#,###,###0.00}';
document.form1.pca_monto_pedido_ma.value='${fld:pca_monto_pedido_ma@#,###,###0.00}';
document.form1.pca_monto_impuesto_ma.value='${fld:pca_monto_impuesto_ma@#,###,###0.00}';
document.form1.pca_monto_descuento_ma.value='${fld:pca_monto_descuento_ma@#,###,###0.00}';
document.form1.pca_monto_bonificacion_ma.value='${fld:pca_monto_bonificacion_ma@#,###,###0.00}';
document.form1.pca_monto_neto_ma.value='${fld:pca_monto_neto_ma@#,###,###0.00}';
setComboValue('smn_centro_facturacion_id','${fld:smn_centro_facturacion_id}','form1');
setComboValue('smn_sub_centro_facturacion_id','${fld:smn_sub_centro_facturacion_id}','form1');
...
setComboValue('pca_estatus_pago','${fld:pca_estatus_pago}','form1');
...
document.form1.pca_tiempo_sug_preparacion.value='${fld:pca_tiempo_sug_preparacion@js}';