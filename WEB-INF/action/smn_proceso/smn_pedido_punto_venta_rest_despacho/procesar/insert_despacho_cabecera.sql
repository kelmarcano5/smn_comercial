...
smn_comercial.smn_pedido_cabecera.pca_usuario,
...
smn_comercial.smn_pedido_cabecera.smn_entidades_rf,
smn_comercial.smn_pedido_cabecera.smn_sucursales_rf,
...
RETURNING smn_pedido_cabecera_id as id_despacho
