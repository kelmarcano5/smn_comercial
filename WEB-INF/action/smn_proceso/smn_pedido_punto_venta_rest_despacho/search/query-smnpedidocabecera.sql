...
where
	smn_comercial.smn_pedido_cabecera.pca_estatus ='ED'
...
smn_comercial.smn_documento.smn_documento_id, comp.aux_descripcion, smn_comercial.smn_pedido_cabecera.pca_cantidad, it.itm_nombre, smn_comercial.smn_pedido_detalle.smn_descripcion_ingrediente,smn_base.smn_auxiliar.aux_descripcion
