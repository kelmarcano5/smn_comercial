select
	...
	when smn_entrega.smn_solicitud_servicio_entregas_cabecera.sec_estatus_proceso='ER' then 'En Preparacion'
...
order by smn_entrega.smn_solicitud_servicio_entregas_detalle.sed_fecha_registro asc