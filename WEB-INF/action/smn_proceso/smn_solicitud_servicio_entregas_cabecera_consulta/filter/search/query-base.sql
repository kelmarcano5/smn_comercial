select
	...
	smn_entrega.smn_solicitud_servicio_entregas_cabecera.sec_descripcion as smn_solicitud_servicio_entregas_cabecera_id,
	...
	smn_entrega.smn_solicitud_servicio_entregas_detalle.sed_tiempo_sug_preparacion as tiempo_preparacion,
	smn_entrega.smn_solicitud_servicio_entregas_cabecera.sec_hora_inicio_preparacion as hora_inicio,
	smn_entrega.smn_solicitud_servicio_entregas_detalle.smn_descripcion_ingrediente as extras,
	smn_entrega.smn_catalogo_item_comercio.cic_tiempo_sug_preparacion as tiempo,
...
WHERE	
	smn_entrega.smn_solicitud_servicio_entregas_detalle.smn_solicitud_servicio_entregas_cabecera_id is not null
	${filter} 
order by
		smn_entrega.smn_solicitud_servicio_entregas_detalle.smn_solicitud_servicio_entregas_cabecera_id
