...
WHERE	
	 smn_entrega.smn_solicitud_servicio_entregas_cabecera.smn_solicitud_servicio_entregas_cabecera_id = ${fld:id} and smn_entrega.smn_solicitud_servicio_entregas_cabecera.sec_estatus_proceso='EP'
