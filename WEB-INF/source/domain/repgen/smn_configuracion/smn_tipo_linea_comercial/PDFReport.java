package domain.repgen.smn_configuracion.smn_tipo_linea_comercial;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("tlc_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("tlc_fecha_registro_ini");
			if (d != null)
			{
