package domain.repgen.smn_configuracion.smn_centro_facturacion;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("cfc_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("cfc_fecha_registro_ini");
			if (d != null)
			{
