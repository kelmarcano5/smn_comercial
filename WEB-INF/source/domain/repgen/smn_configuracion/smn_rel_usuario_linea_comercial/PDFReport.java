package domain.repgen.smn_configuracion.smn_rel_usuario_linea_comercial;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("smn_linea_comercial_id");
			if (d != null)
			{
			name  = "b_linea_comercial";
			label = "${lbl:b_linea_comercial}";
		...
		d = rs.getString("smn_linea_comercial_id_name");
			if (d != null)
			{
			name  = "b_linea_comercial";
			label = "${lbl:b_linea_comercial}";
