package domain.repgen.smn_configuracion.smn_rel_cliente_forma_pago;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("rcf_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("rcf_fecha_registro_ini");
			if (d != null)
			{
