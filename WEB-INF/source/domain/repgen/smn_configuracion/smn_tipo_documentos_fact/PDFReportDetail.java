package domain.repgen.smn_configuracion.smn_tipo_documentos_fact;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("tdf_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("tdf_fecha_registro_ini");
			if (d != null)
			{
