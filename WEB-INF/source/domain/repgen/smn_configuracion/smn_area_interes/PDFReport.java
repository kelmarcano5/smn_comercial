package domain.repgen.smn_configuracion.smn_area_interes;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("ari_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("ari_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("ari_fecha_registro_ini");
			if (d != null)
			{
