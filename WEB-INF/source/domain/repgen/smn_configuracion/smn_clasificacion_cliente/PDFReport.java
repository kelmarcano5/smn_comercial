package domain.repgen.smn_configuracion.smn_clasificacion_cliente;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("ccl_fecha_registro_ini");
			if (d != null)
			{
		...
		d = rs.getString("ccl_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("ccl_fecha_registro_fin");
			if (d != null)
			{
