package domain.repgen.smn_proceso.smn_evento;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
			...
			if (d != null)
			{
			name  = "b_description_short";
			label = "${lbl:b_description_short}";
		...
		d = rs.getString("eve_descripcion_corta");
			if (d != null)
			{
			name  = "b_description_short";
			label = "${lbl:b_description_short}";
		...
		d = rs.getString("eve_fecha_registro_fin");
			if (d != null)
			{
			name  = "b_store_date";
		...
		d = rs.getString("eve_fecha_registro_ini");
			if (d != null)
			{
			name  = "b_store_date";
			label = "${lbl:b_store_date}";
