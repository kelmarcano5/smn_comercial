package domain.repgen.smn_proceso.smn_orden_servicio_detalle;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("smn_nivel_estructura_rf");
			if (d != null)
			{
			name  = "b_structure_level";
			label = "${lbl:b_structure_level}";
		...
		d = rs.getString("smn_orden_servicio_id");
			if (d != null)
			{
			name  = "b_service_order";
			label = "${lbl:b_service_order}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_nivel_estructura_rf_name");
			if (d != null)
			{
			name  = "b_structure_level";
			label = "${lbl:b_structure_level}";
		...
		d = rs.getString("osd_fecha_registro_fin");
			if (d != null)
			{
			name  = "b_store_date";
		...
		d = rs.getString("osd_fecha_registro_ini");
			if (d != null)
			{
			name  = "b_store_date";
			label = "${lbl:b_store_date}";
		...
		d = rs.getString("smn_componentes_rf");
			if (d != null)
			{
			name  = "b_component";
		...
		d = rs.getString("smn_prestador_servicio_rf_name");
			if (d != null)
			{
			name  = "b_component";
			label = "${lbl:b_component}";
		...
		d = rs.getString("smn_componentes_rf_name");
			if (d != null)
			{
			name  = "b_component";
			label = "${lbl:b_component}";
