package domain.repgen.smn_registro.smn_llamadas;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("lla_descripcion");
			if (d != null)
			{
			name  = "b_description";
		...
		d = rs.getString("smn_prospecto_id");
			if (d != null)
			{
			name  = "b_leaflet";
			label = "${lbl:b_leaflet}";
		...
		d = rs.getString("lla_fecha_registro_fin");
			if (d != null)
			{
			name  = "b_store_date";
		...
		d = rs.getString("lla_fecha_registro_ini");
			if (d != null)
			{
			name  = "b_store_date";
			label = "${lbl:b_store_date}";
		...
		d = rs.getString("smn_prospecto_id_name");
			if (d != null)
			{
			name  = "b_leaflet";
			label = "${lbl:b_leaflet}";
